...
//文件保存目录路径
String savePath = request.getSession().getServletContext().getRealPath("/")+"/uploadImages_ofall/";
java.io.File fpath = new java.io.File(savePath);
if (!fpath.exists()) {
	fpath.mkdirs();
}
...
//文件保存目录URL
String saveUrl  = request.getContextPath()+"/uploadImages_ofall/";
