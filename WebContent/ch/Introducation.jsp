	...
	$.ajax({
        ...
        success: function(newsListJsonStr){
        	...
        	if(newsList.length > 0){
        		str += "<p class='overviewP'>"+newsList[0].n_content.substr(0,200)+"...</p><a class='readmore readContent' href='#' id='readContent"+newsList[0].n_id+"'>更多>></a>";
        		ul_body.html(str);
        		...
        		var emptyStr = "<div class='description'><h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;暂无相关信息</h3>"
        		    +"</div>";
        	...
        	if(newsList.length > 0){
        		for (var i = 0 ;i < newsList.length;i++){
        			...
        			if(newsList[i].n_content == ""){
        				...
        				str +="<li><div class='description'><a href='<%=basePath%>ch/document.jsp?contentId="+newsList[i].n_id+"' class='readContent' id='readContent"+newsList[i].n_id+"' title='"+newsList[i].n_summary+"'><h3>"+newsList[i].n_titles+
        		        "</h3></a>"
        		        +"</div></li>";
        			}
    			}
...
<body>
<jsp:include page="IQAhead.jsp"></jsp:include>
