	...
	$.ajax({
        ...
        success: function(newsListJsonStr){
        	...
        	if(newsList.length > 0){
        		str += "<p class='overviewP'><span>"+newsList[0].n_content.substr(0,200)+"...</span></p><a class='readmoreForOverview readContent' href='#' id='readContent"+newsList[0].n_id+"'>更多>></a>";
          	}
        		ul_body.html(str);
        ...
        success: function(newsListJsonStr){
        	...
        	if(newsList.length > 0){
        		for (var i = 0 ;i < newsList.length;i++){
        			...
        			if(newsList[i].n_content == ""){
        			    str +="<li><div class='description'><a id='readContent"+newsList[i].n_id+"' title='"+newsList[i].n_summary+"'><h3>"+newsList[i].n_titles+
        		        "</h3></a>"
        		        +"</div></li>";
        			}
        			else{
