	...
	$.ajax({
        ...
        success: function(newsListJsonStr){
        	...
        	if(newsList.length > 0){
        		...
        		ul_body.html(str);
        		var contentStr ="<div class='report'>"+newsList[0].n_titles+"\n"+newsList[0].n_content+"</div><div class='clear'></div><hr style='border:1px dashed #999;border-bottom:0;border-right:0; border-left:0;width:90%;'><a class='readmore' href='document.jsp?contentId="+newsList[0].n_id+"'>更多>></a>";
...
<jsp:include page="IQAhead.jsp" flush="false" /> 
...
<div class="container">
  ...
  <div class="content">
   ...
   <div class="con_header">
    <h2>教学成果奖</h2>
    <a class="readmore" href="#" id="moreResult">更多>></a>
   </div>
    <ul id="resultlist">
    </ul>
   </div>
   ...
   <div class="con_header">
    <h2>研究论文</h2>
    <a class="readmore" href="#" id="morePaper">更多>></a>
   </div>
    <ul id="paperlist">
    </ul>
   </div>
   ...
   <div class="con_header">
    <h2>项目评审</h2>
    <a class="readmore" href="#" id="moreReview">更多>></a>
   </div>
    <ul id="reviewlist">
    </ul>
   </div>
