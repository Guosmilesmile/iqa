...
<head lang="zh">
	...
	function GetSubClass(id)
    {
    	...
    	{
			subclass = 62;
			$("#subClassName").html("上级文件");
    	}
    	else if(id==2)//厦门大学本科教学管理制度
    	{
    		subclass = 63;
    		$("#subClassName").html("厦门大学本科教学管理制度");
    	}
    	else if(id==3)//厦门大学学生手册
    	{
    		subclass = 64;
    		$("#subClassName").html("厦门大学学生手册");
    	}
    	else if(id==4)//厦门大学新生学业导航
    	{
    		subclass = 65;
    		$("#subClassName").html("厦门大学新生学业导航");
    	}
    	else if(id==5)//厦门大学教师手册
    	{
    		subclass = 66;
    		$("#subClassName").html("厦门大学教师手册");
    	}
    }
	</script>
    <script>
	...
	$.ajax({
        ...
        success: function(newsListJson){
        	...
        	if(newsList.length > 0){
        		var trList = "";
            	var tr = "<tr ><td><i class='icon icon-exclamation-sign'></td> <td style='padding:5px 5px;width:500px;display:inline-block;border-style:None;overflow:hidden;white-space: nowrap;text-overflow: ellipsis;'><a>{0}</a></td><td>{1}</td></tr>";
            	for(var i = 0; i < newsList.length; i++)
            	{
            		trList = trList+tr.format(newsList[i].n_content, formatterdate(newsList[i].n_publishtime));
            	}
...
<body  class="style-bright">
    <div id="wrapper">
        ...
        <div id="main" class="container container-fluid" >
            <br class="row-fluid">
                <div id="sub-nav" style="width:260px">
                    <span class="sub-nav-title">政策文件</span>
                    <!-- left menu ================================================== -->
                    <ul>
                    	<li><a href="./iqa_file.jsp?id=1"><i class="icon icon-chevron-right"></i>上级文件</a></li>
						<li><a href="./iqa_file.jsp?id=2"><i class="icon icon-chevron-right"></i>厦门大学本科教学管理制度</a></li>
						<li><a href="./iqa_file.jsp?id=4"><i class="icon icon-chevron-right"></i>厦门大学新生学业导航</a></li>
						<li><a href="./iqa_file.jsp?id=5"><i class="icon icon-chevron-right"></i>厦门大学教师手册</a></li>
                    </ul>
                    </ul>
                </div>
                <div id="main-content" style="width:660px">
                    <h3 id="subClassName">上级文件</h3>
                    <table id="iqaProjects">
                    </table>
                    <div class="digg">
                    </div>
                </div>
