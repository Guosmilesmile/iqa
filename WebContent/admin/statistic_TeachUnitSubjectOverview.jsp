...
function getData(queryParams){
	$('#grid').datagrid({
		url: '<%=basePath%>getteachunitsubjectoverview',
		...
		columns: [[
			...
			{field:'bachelorSubjectNumber',title:'本科专业数',
			},
			
			{field:'postPhdFlowSpotNumber',title:'博士后流动站数',
			},
			{field:'phdAuthFir',title:'博士学位授权一级学科点',
			},
			
			{field:'phdAuthSec',title:'博士学位授权二级学科点（不含一级覆盖点）',
			},
			{field:'masterAuthFir',title:'硕士学位一级学科点',
			},
			{field:'masterAuthSec',title:'硕士学位二级学科点（不含一级覆盖点）',
			},
			{field:' importantSubject',title:'重点学科数',
			},
		      ]
		],
	...
	function _Export(){
		...
		location.href="<%=basePath%>exportteachunitsubjectoverview?rowdata="+rowstr;
	}
