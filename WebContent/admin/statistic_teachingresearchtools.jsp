...
function getCookie(objName){//获取指定名称的cookie的值 
	...
	function getData(queryParams){
		$('#grid').datagrid({
			url: '<%=basePath%>getteachingresearchtools',
			...
			columns: [[
			   ...
			   {title:"教学、科研仪器设备",colspan:4,rowspan:1},

			 ],[
				{field:'totalWealth',title:'资产总值（万元）',rowspan:1,},
				{field:'avg',title:'生均（万元）',rowspan:1,},
				{field:'newThisYear',title:'当年新增（万元）',rowspan:1,},
				{field:'newThisYearRate',title:'当年新增所占比例',rowspan:1,},
		...
		location.href="<%=basePath%>exportteachingresearchtools="+rowstr;
	}
</script>
