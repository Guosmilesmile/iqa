	...
	function getData(queryParams){
		$('#grid').datagrid({
			...
			columns: [[
				...
				{field:'total',title:'签订合作协议机构总数',rowspan:1,},
				{field:'academic',title:'其中：学术机构',rowspan:1,},
				{field:'enterprise',title:'行业机构和企业',rowspan:1,},
				{field:'gov',title:'地方政府',rowspan:1,},
		...
		location.href="<%=basePath%>exportpartnership="+rowstr;
	}
</script>
