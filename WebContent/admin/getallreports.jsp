...
<body>
	<%	
		...
		param.put(NewsTable.N_SUB_CLASS, "报告");
    ...
    <div class="pagin">
    	<div class="message">共<i class="blue"> <%=rowcount %> </i>个纪录</div>
         <ul class="paginList">
        <li class="paginItem"><a href=getallreports.jsp?currentPage=1 target='_self' >首页</a></li>
        <li class="paginItem"><a href=getallreports.jsp?currentPage=<%=currentPage-1%> target='_self'>上页</a></li>
        <li class="paginItem"><a href=getallreports.jsp?currentPage=<%=currentPage+1%> target='_self'>下页</a></li>
        <li class="paginItem"><a href=getallreports.jsp?currentPage=<%=pageCount%> target='_self' >末页</a></li>
        </ul> 
    </div>
