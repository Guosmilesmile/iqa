...
function getData(queryParams){
	$('#grid').datagrid({
		url: '<%=basePath%>getmanagerstructure',
...
frozenColumns:[[
		...
		columns: [[
			...
			{title:"学位",width:500,colspan:4,},
			{title:"年龄",width:500,colspan:4,},
						
		],[
			{field:'high',title:'正高级',rowspan:1,
			},
			{field:'midhigh',title:'副高级',rowspan:1,
			},
			{field:'mid',title:'中级',rowspan:1,
			},
			{field:'low',title:'初级',rowspan:1,
			},
			{field:'common',title:'无职称',rowspan:1,
			},
			
			{field:'phd',title:'博士',rowspan:1,
			},
			{field:'master',title:'硕士',rowspan:1,
			},
			{field:'bachelor',title:'学士',rowspan:1,
			},
			{field:'sb',title:'无学位',rowspan:1,
			},

			{field:'young',title:'35岁以下',rowspan:1,
			},
			{field:'midyoung',title:'36-45',rowspan:1,
			},
			{field:'miold',title:'46-55',rowspan:1,
			},
			{field:'old',title:'56岁以上',rowspan:1,
			},
	...
	function _Export(){
		...
		location.href="<%=basePath%>exportmanagerstructure?rowdata="+rowstr;
	}
