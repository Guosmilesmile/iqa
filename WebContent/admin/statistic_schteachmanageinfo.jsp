...
function getCookie(objName){//获取指定名称的cookie的值 
	...
	function getData(queryParams){
		$('#grid').datagrid({
			...
			columns: [[
						{field:'mi_departmentname',title:'单位',sortable:true,width:100},
			            ...
			            {field:'mi_professionaltitle',title:'职称',sortable:true,width:140,},
			            {field:'mi_degrees',title:'学位',sortable:true,width:100,},
				]
			],
