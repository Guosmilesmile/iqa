...
function getCookie(objName){//获取指定名称的cookie的值 
	...
	function getData(queryParams){
		$('#grid').datagrid({
			url: '<%=basePath%>getgoodcoursebuild',
			...
			frozenColumns:[[
			    		    ...
			    		    {field:'rowTitle',title:'级别',align:'left'} 
			    		]],
			    		
			columns: [[
			    					
			   
				{field:'nation',title:'国家级',rowspan:1,},
				{field:'province',title:'省部级',rowspan:1,},
		...
		location.href="<%=basePath%>exportgoodcoursebuild="+rowstr;
	}
</script>
