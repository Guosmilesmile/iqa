...
function getData(queryParams){
	$('#grid').datagrid({
		url: '<%=basePath%>getteachersreformandachieve',
		...
		columns: [[
			...
			{title:"教师主持教育教学研究与改革项目",colspan:5,rowspan:1},
	...
	function _Export(){
		...
		location.href="<%=basePath%>exportteachrevoresult?rowdata="+rowstr;
	}
