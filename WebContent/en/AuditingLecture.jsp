        	...
        	if(newsList.length > 0){
        		...
        		for (var i = 0 ;i < newsList.length;i++){
        			...
        			if(newsList[i].n_content == ""){
        				...
        				str +="<li><div class='description'><a href='<%=basePath%>en/document.jsp?contentId="+newsList[i].n_id+"' class='readContent' id='readContent"+newsList[i].n_id+"' title='"+newsList[i].n_summary+"'><h3>"+newsList[i].n_titles+
        		        "</h3></a>"
        		        +"</div></li>";
        			}
    			}
