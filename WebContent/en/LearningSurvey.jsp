	...
	$.ajax({
        ...
        success: function(newsListJsonStr){
        	...
        	if(newsList.length > 0){
        		...
        		ul_body.html(str);
        		var contentStr ="<div class='report'><h3>"+newsList[0].n_titles+"</h3>"+newsList[0].n_content+"</div><div class='clear'></div><hr style='border:1px dashed #999;border-bottom:0;border-right:0; border-left:0;width:90%;'><a class='readmore' href='document.jsp?contentId="+newsList[0].n_id+"'>Read More>></a>";
...
<div class="container">
  ...
  <div class="content">
   ...
   <div class="con_header">
    <h2>FILES</h2>
    <a class="readmore" href="#" id="moreFiles">Read More>></a>
   </div>
    <ul id="fileList">
    </ul>
   </div>
   ...
   <div class="con_header">
    <h2>REPORTS</h2>
    <a class="readmore" href="#" id="moreReports">Read More>></a>
   </div>
    <ul id="reportsList">
    </ul>
   </div>
