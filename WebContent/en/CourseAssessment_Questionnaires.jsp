        	...
        	if(newsList.length > 0){
        		...
        		for (var i = 0 ;i < newsList.length;i++){
        			...
        			if (newsList[i].n_content == ""||newsList[i].n_content == null) {
        				str +="<li><div class='description'><h3>"+
           			 "<a title='"+newsList[i].n_summary+"' href='#'>"+newsList[i].n_titles
             		    +"</a></h3></div></li>";
					}else{
						str +="<li><div class='description'><h3>"+
	        			 "<a title='"+newsList[i].n_summary+"' href='<%=basePath%>en/document.jsp?contentId="+newsList[i].n_id+"'>"+newsList[i].n_titles
	          		    +"</a></h3></div></li>";
					}
    			}
        		...
        		str += "<li><div class='description'>"+
        		            "<h3>NO RELATED INFORMATION NOW.</h3>"+        		            
        		            "</div></li>";
        		ul_body.html(str);
