 ...
 */
@WebServlet("/Sec_GetEducationMoney")
public class Sec_GetEducationMoney extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetEducationMoney() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<EducationMoney> model = new GridDataModel<EducationMoney>();
	    ...
	    int total = emdao.getEducationMoneyCount(queryParams);
	    ...
	    model.setRows(emdao.getAllEducationMoney(start, end, sortStr, orderStr, queryParams));
