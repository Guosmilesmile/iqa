 ...
 *
 */
@WebServlet("/Sec_GetRecruitExceedScore")
public class Sec_GetRecruitExceedScore extends HttpServlet
{
	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();

	public Sec_GetRecruitExceedScore()
	{
		super();
	}
	@Override
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		GridDataModel<RecruitExceedScore> model = new GridDataModel<RecruitExceedScore>();
	    ...
	    String college = request.getParameter("res_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(RecruitExceedScoreTable.RES_ISNULL, isnull);
	    }
	    ...
	    int total = resDao.getRecruitExceedScoreCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(resDao.getRecruitExceedScores(start, end, sortStr, orderStr, queryParams, deadLine));	    
