 ...
 *
 */
@WebServlet("/Sec_GetForeignStudentInfoServlet")
public class Sec_GetForeignStudentInfoServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec_GetForeignStudentInfoServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		GridDataModel<ForeignStudentInfo> model = new GridDataModel<ForeignStudentInfo>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(ForeignStudentInfoTable.ISNULL, isnull);
	    }
		...
		int total = fsiDao.getForeignStudentInfoCount(queryParams);
		if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
		...
		model.setRows(fsiDao.getForeignStudentInfo(start, end, sortStr, orderStr, queryParams, deadLine));
