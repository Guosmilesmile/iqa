 ...
 *
 */
@WebServlet("/Sec_GetTeachingQualityMonitorServlet")
public class Sec_GetTeachingQualityMonitorServlet extends HttpServlet {
     ...
     */
    public Sec_GetTeachingQualityMonitorServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TeachingQualityMonitor> model = new GridDataModel<TeachingQualityMonitor>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeachingQualityMonitorTable.TQM_ISNULL, isnull);
	    }
	    ...
	    int total = teachingQualityMonitorDao.getTeachingQualityMonitorCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(teachingQualityMonitorDao.getTeachingQualityMonitor(start, end, sortStr, orderStr,queryParams,deadLine));
