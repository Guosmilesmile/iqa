...
/**
 * Servlet implementation class Sec_GetFixedAssetsServlet
 */
@WebServlet("/Sec_GetFixedAssetsServlet")
public class Sec_GetFixedAssetsServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetFixedAssetsServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				GridDataModel<FixedAssets> model = new GridDataModel<FixedAssets>();
				...
				String college = request.getParameter("fa_college");
				...
				if(isnull != null && !"".equals(isnull)){
				    queryParams.put(FixedAssetsTable.ISNULL, isnull);
				}

				int total = fadao.getFixedAssetsCount(queryParams);
				...
				model.setRows(fadao.getAllFixedAssets(start, end, sortStr, orderStr,
						queryParams));
