...
/**
 * Servlet implementation class Sec_GetListenSituationServlet
 */
@WebServlet("/Sec_GetListenSituationServlet")
public class Sec_GetListenSituationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec_GetListenSituationServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		GridDataModel<ListenSituation> model = new GridDataModel<ListenSituation>();
		...
		String college = request.getParameter("ls_college");
		...
		if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(ListenSituationTable.ISNULL, isnull);
	    }

		int total = lsdao.getListenSituationCount(queryParams);
		...
		model.setRows(lsdao.getAllListenSituation(start, end, sortStr, orderStr,
				queryParams));
