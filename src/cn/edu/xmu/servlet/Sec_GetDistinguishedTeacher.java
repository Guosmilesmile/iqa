...
/**
 * @author zhantu
 * Servlet implementation class GetDistinguishedTeacher
 */
@WebServlet("/GetDistinguishedTeacher")
public class Sec_GetDistinguishedTeacher extends HttpServlet {
     ...
     */
    public Sec_GetDistinguishedTeacher() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<DistinguishedTeacher> model = new GridDataModel<DistinguishedTeacher>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(DistinguishedTeacherTable.ISNULL, isnull);
	    }
	    int total = dtdao.getDistinguishedTeacherCount(queryParams);
	    ...
	    model.setRows(dtdao.getDistinguishedTeacher(start, end, sortStr, orderStr, queryParams, deadLine));
