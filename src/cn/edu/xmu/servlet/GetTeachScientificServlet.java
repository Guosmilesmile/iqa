 ...
 * date 2015-06-29
 */
@WebServlet("/GetTeachScientificServlet")
public class GetTeachScientificServlet extends HttpServlet {
     ...
     */
    public GetTeachScientificServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		TeachScientificDao trdao = new TeachScientificDaoImpl();
		GridDataModel<TeachScientific> model = new GridDataModel<TeachScientific>();
		String pageStr = request.getParameter("page");
	    String rowsStr = request.getParameter("rows");
	    String sortStr = request.getParameter("sort");
	    String orderStr = request.getParameter("order");
	    String college = request.getParameter("ts_college");
...
/*	    else {
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeachScientificTable.ISNULL, isnull);
	    }
	    
	    int total = trdao.getTeachScientificCount(queryParams);
	    ...
	    model.setRows(trdao.getAllTeachScientific(start, end, sortStr, orderStr,queryParams));
