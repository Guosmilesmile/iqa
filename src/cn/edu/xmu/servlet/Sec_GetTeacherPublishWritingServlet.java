 ...
 */
@WebServlet("/Sec_GetTeacherPublishWritingServlet")
public class Sec_GetTeacherPublishWritingServlet extends HttpServlet {
     ...
     */
    public Sec_GetTeacherPublishWritingServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TeacherPublishWriting> model = new GridDataModel<TeacherPublishWriting>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeacherPublishWritingTable.TPW_ISNULL, isnull);
	    }
	    ...
	    int total = teacherPublishWritingDao.getTeacherPublishWritingCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(teacherPublishWritingDao.getTeacherPublishWriting(start, end, sortStr, orderStr,queryParams,deadLine));
