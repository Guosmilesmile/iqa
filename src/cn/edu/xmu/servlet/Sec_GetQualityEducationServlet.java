...
/**
 * Servlet implementation class Sec_GetQualityEducationServlet
 */
@WebServlet("/Sec_GetQualityEducationServlet")
public class Sec_GetQualityEducationServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetQualityEducationServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				GridDataModel<QualityEducation> model = new GridDataModel<QualityEducation>();
				...
				String college = request.getParameter("qe_college");
				...
				if(isnull != null && !"".equals(isnull)){
			    	queryParams.put(QualityEducationTable.ISNULL, isnull);
			    }

				int total = qedao.getQualityEducationCount(queryParams);
				...
				model.setRows(qedao.getAllQualityEducation(start, end, sortStr, orderStr,
						queryParams));
