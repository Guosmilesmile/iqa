 ...
 */
@WebServlet("/Sec_GetStudentPatent")
public class Sec_GetStudentPatent extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetStudentPatent() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<StudentPatent> model = new GridDataModel<StudentPatent>();
	    ...
	    int total = apdao.getStudentPatentCount(queryParams);
	    ...
	    model.setRows(apdao.getAllStudentPatent(start, end, sortStr, orderStr, queryParams));
