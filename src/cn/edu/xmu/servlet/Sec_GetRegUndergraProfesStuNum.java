 ...
 *
 */
@WebServlet("/Sec_GetRegUndergraProfesStuNum")
public class Sec_GetRegUndergraProfesStuNum extends HttpServlet
{

	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();

	public Sec_GetRegUndergraProfesStuNum()
	{
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		GridDataModel<RegUndergraProfesStuNum> model = new GridDataModel<RegUndergraProfesStuNum>();
	    ...
	    String college = request.getParameter("rupsn_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(RegUndergraProfesStuNumTable.RUPSN_ISNULL, isnull);
	    }
	    ...
	    int total = rupsnDao.getRegUndergraProfesStuNumCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(rupsnDao.getRegUndergraProfesStuNums(start, end, sortStr, orderStr, queryParams, deadLine));	    
