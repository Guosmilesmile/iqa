 ...
 * 3-3 管理人员基本信息
 */
@WebServlet("/Sec_GetManagerInfoServlet")
public class Sec_GetManagerInfoServlet extends HttpServlet{
     ...
     */
    public Sec_GetManagerInfoServlet(){
    	super();
    }
    /**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {						
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(ManagerInfoTable.ISNULL, isnull);
	    }
	    ...
	    int total = midao.getManagerInfoCount(queryParams);
