 ...
 *
 */
@WebServlet("/Sec_GetTeacherParticipationSum")
public class Sec_GetTeacherParticipationSum extends HttpServlet
{

	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();
	
	public Sec_GetTeacherParticipationSum()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		GridDataModel<TeacherParticipationSum> model = new GridDataModel<TeacherParticipationSum>();
	    ...
	    String college = request.getParameter("tps_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeacherParticipationSumTable.TPS_ISNULL, isnull);
	    }
	    ...
	    int total = tpsDao.getTeacherParticipationSumCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(tpsDao.getTeacherParticipationSums(start, end, sortStr, orderStr, queryParams, deadLine));	    
