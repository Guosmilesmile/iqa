 ...
 *
 */
@WebServlet("/Sec_GetEnrollCategoryInfoservlet")
public class Sec_GetEnrollCategoryInfoservlet extends HttpServlet{
     ...
     */
    public Sec_GetEnrollCategoryInfoservlet(){
    	super();
    }
    /**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {						
		...
		GridDataModel<EnrollCategoryInfo> model = new GridDataModel<EnrollCategoryInfo>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(EnrollCategoryInfoTable.ISNULL, isnull);
	    }
	    ...
	    int total = eciDao.getEnrollCategoryInfoCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(eciDao.getEnrollCategoryInfo(start, end, sortStr, orderStr,queryParams,deadLine));	    
