 ...
 *
 */
@WebServlet("/Sec_GetSchoolLeaderInfo")
public class Sec_GetSchoolLeaderInfo extends HttpServlet
{

	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();

	public Sec_GetSchoolLeaderInfo()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		GridDataModel<SchoolLeaderInfo> model = new GridDataModel<SchoolLeaderInfo>();
	    ...
	    String college = request.getParameter("sli_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(SchoolLeaderInfoTable.SLI_ISNULL, isnull);
	    }
	    ...
	    int total = sliDao.getSchoolLeaderInfoCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(sliDao.getSchoolLeaderInfos(start, end, sortStr, orderStr, queryParams, deadLine));	    
