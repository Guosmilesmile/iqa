 ...
 */
@WebServlet("/Sec_GetTeacherPaper")
public class Sec_GetTeacherPaper extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetTeacherPaper() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TeacherPaper> model = new GridDataModel<TeacherPaper>();
	    ...
	    if(college != null && !"".equals(college)){
	    	if (college.contains("学院")) {//具体的学院才过滤
	    		queryParams.put(TeacherPaperTable.TP_COLLEGE, college);
			}
	    ...
	    int total = apdao.getTeacherPaperCount(queryParams);
	    ...
	    model.setRows(apdao.getAllTeacherPaper(start, end, sortStr, orderStr, queryParams));
