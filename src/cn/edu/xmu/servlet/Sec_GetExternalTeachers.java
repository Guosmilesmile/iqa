 ...
 *
 */
@WebServlet("/GetExternalTeachers")
public class Sec_GetExternalTeachers extends HttpServlet {
...
//	private SuperMajorDao superMajorDao = new SuperMajorDaoImpl();
     ...
     */
    public Sec_GetExternalTeachers(){
    	super();
    }
    /**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<ExternalTeacher> model = new GridDataModel<ExternalTeacher>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(ExternalTeacherTable.ISNULL, isnull);
	    }
	    int total = etdao.getExternalTeacherCount(queryParams);
	    ...
	    model.setRows(etdao.getExternalTeacher(start, end, sortStr, orderStr, queryParams, deadLine));
