...
/**
 * @author zhantu
 * Servlet implementation class GetEmploymentSituationofCollegeGraduates
 */
@WebServlet("/GetEmploymentSituationofCollegeGraduates")
public class Sec_GetEmploymentSituationofCollegeGraduates extends HttpServlet {
     ...
     */
    public Sec_GetEmploymentSituationofCollegeGraduates() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<EmploymentSituationofCollegeGraduates> model = new GridDataModel<EmploymentSituationofCollegeGraduates>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(EmploymentSituationofCollegeGraduatesTable.ISNULL, isnull);
	    }
	    
	    int total = escgdao.getEmploymentSituationofCollegeGraduatesCount(queryParams);
	    ...
	    model.setRows(escgdao.getEmploymentSituationofCollegeGraduates(start, end, sortStr, orderStr, queryParams, deadLine));
