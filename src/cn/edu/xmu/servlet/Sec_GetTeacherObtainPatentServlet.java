 ...
 */
@WebServlet("/Sec_GetTeacherObtainPatentServlet")
public class Sec_GetTeacherObtainPatentServlet extends HttpServlet {
     ...
     */
    public Sec_GetTeacherObtainPatentServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TeacherObtainPatent> model = new GridDataModel<TeacherObtainPatent>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeacherObtainPatentTable.TOP_ISNULL, isnull);
	    }
	    ...
	    int total = teacherObtainPatentDao.getTeacherObtainPatentCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(teacherObtainPatentDao.getTeacherObtainPatent(start, end, sortStr, orderStr,queryParams,deadLine));
