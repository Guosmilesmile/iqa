 ...
 *
 */
@WebServlet("/Sec_GetUndergraStuInlandCommu")
public class Sec_GetUndergraStuInlandCommu extends HttpServlet
{

	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();
	public Sec_GetUndergraStuInlandCommu()
	{
		super();
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		GridDataModel<UndergraStuInlandCommu> model = new GridDataModel<UndergraStuInlandCommu>();
	    ...
	    String college = request.getParameter("usic_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(UndergraStuInlandCommuTable.USIC_ISNULL, isnull);
	    }
	    ...
	    int total = usicDao.getUndergraStuInlandCommuCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(usicDao.getUndergraStuInlandCommus(start, end, sortStr, orderStr, queryParams, deadLine));	    
