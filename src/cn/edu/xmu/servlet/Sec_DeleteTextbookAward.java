...
/**
 * Servlet implementation class DeleteTextbookAward
 */
@WebServlet("/DeleteTextbookAward")
public class Sec_DeleteTextbookAward extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_DeleteTextbookAward() {
        super();
    }
