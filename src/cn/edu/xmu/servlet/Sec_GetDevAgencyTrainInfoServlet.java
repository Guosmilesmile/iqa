 ...
 *
 */
@WebServlet("/Sec_GetDevAgencyTrainInfoServlet")
public class Sec_GetDevAgencyTrainInfoServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec_GetDevAgencyTrainInfoServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		GridDataModel<DevAgencyTrainInfo> model = new GridDataModel<DevAgencyTrainInfo>();
		...
		String college = request.getParameter("dati_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(DevAgencyTrainInfoTable.ISNULL, isnull);
	    }
		...
		int total = datiDao.getDevAgencyTrainInfoCount(queryParams);
		if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
		...
		model.setRows(datiDao.getDevAgencyTrainInfo(start, end, sortStr, orderStr, queryParams,deadLine));
