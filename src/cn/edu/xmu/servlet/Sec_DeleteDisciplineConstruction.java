 ...
 */
@WebServlet("/DeleteDisciplineConstruction")
public class Sec_DeleteDisciplineConstruction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_DeleteDisciplineConstruction() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String dc_id = request.getParameter("dcids");
		
		String dcid[] = dc_id.split(",");
		
		DisciplineConstructionDao dcDao  = new DisciplineConstructionDaoImpl();
		boolean result = false;
		try {
			result = dcDao.batchDelete(dcid);
