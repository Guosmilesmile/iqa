...
/**
 * @author zhantu
 * Servlet implementation class GetTextbookAward
 */
@WebServlet("/GetTextbookAward")
public class Sec_GetTextbookAward extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TextbookAward> model = new GridDataModel<TextbookAward>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TextbookAwardTable.ISNULL, isnull);
	    }
	    
	    int total = tadao.getTextbookAwardCount(queryParams);
	    ...
	    model.setRows(tadao.getTextbookAward(start, end, sortStr, orderStr, queryParams, deadLine));
