 ...
 *
 */
@WebServlet("/Sec_GetAdmissionCriteriaAndNumberServlet")
public class Sec_GetAdmissionCriteriaAndNumberServlet extends HttpServlet{
	private static final long serialVersionUID = 1L;
	private TableListDao tableListDao = new TableListDaoImpl();
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec_GetAdmissionCriteriaAndNumberServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		String college = request.getParameter("acn_college");
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(AdmissionCriteriaAndNumberTable.ISNULL, isnull);
	    }
		...
		int total = acnDao.getAdmissionCriteriaAndNumberCount(queryParams);
		if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
		...
		model.setRows(acnDao.getAdmissionCriteriaAndNumber(start, end, sortStr, orderStr, queryParams, deadLine));
