 ...
 */
@WebServlet("/Sec_GetAllForeignExchangeServlet")
public class Sec_GetAllForeignExchangeServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;	
	private TableListDao tableListDao = new TableListDaoImpl();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetAllForeignExchangeServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<ForeignExchange> model = new GridDataModel<ForeignExchange>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(ForeignExchangeTable.FE_ISNULL, isnull);
	    }
	    ...
	    int total = foreignEchangeDao.getForeignExchangeCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(foreignEchangeDao.getForeignExchanges(start, end, sortStr, orderStr,queryParams,deadLine));
