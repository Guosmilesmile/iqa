...
/**
 * @author zhantu
 * Servlet implementation class GetRoomAreaofTeachingAdministration
 */
@WebServlet("/GetRoomAreaofTeachingAdministration")
public class Sec_GetRoomAreaofTeachingAdministration extends HttpServlet {
     ...
     */
    public Sec_GetRoomAreaofTeachingAdministration() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<RoomAreaofTeachingAdministration> model = new GridDataModel<RoomAreaofTeachingAdministration>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(RoomAreaofTeachingAdministrationTable.ISNULL, isnull);
	    }
	    
	    int total = ratadao.getRoomAreaofTeachingAdministrationCount(queryParams);
	    ...
	    model.setRows(ratadao.getRoomAreaofTeachingAdministration(start, end, sortStr, orderStr, queryParams, deadLine));
