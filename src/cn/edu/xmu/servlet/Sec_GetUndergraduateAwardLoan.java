...
/**
 * @author zhantu
 * Servlet implementation class GetUndergraduateAwardLoan
 */
@WebServlet("/GetUndergraduateAwardLoan")
public class Sec_GetUndergraduateAwardLoan extends HttpServlet {
     ...
     */
    public Sec_GetUndergraduateAwardLoan() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<UndergraduateAwardLoan> model = new GridDataModel<UndergraduateAwardLoan>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(UndergraduateAwardLoanTable.ISNULL, isnull);
	    }
	    int total = ualdao.getUndergraduateAwardLoanCount(queryParams);
	    ...
	    model.setRows(ualdao.getUndergraduateAwardLoan(start, end, sortStr, orderStr, queryParams, deadLine));
