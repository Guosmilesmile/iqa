 ...
 */
@WebServlet("/Sec_GetFourSix")
public class Sec_GetFourSix extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetFourSix() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<FourSix> model = new GridDataModel<FourSix>();
	    ...
	    if(college != null && !"".equals(college)){
	    	if (college.contains("学院")) {//具体的学院才过滤
	    		queryParams.put(FourSixTable.FX_COLLEGE, college);
			}
	    ...
	    int total = apdao.getFourSixCount(queryParams);
	    ...
	    model.setRows(apdao.getAllFourSix(start, end, sortStr, orderStr, queryParams));
