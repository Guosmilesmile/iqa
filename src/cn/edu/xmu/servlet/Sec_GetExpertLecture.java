...
/**
 * @author zhantu
 * Servlet implementation class GetExpertLecture
 */
@WebServlet("/GetExpertLecture")
public class Sec_GetExpertLecture extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<ExpertLecture> model = new GridDataModel<ExpertLecture>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(ExpertLectureTable.ISNULL, isnull);
	    }
	    int total = eldao.getExpertLectureCount(queryParams);
	    ...
	    model.setRows(eldao.getExpertLecture(start, end, sortStr, orderStr, queryParams, deadLine));
