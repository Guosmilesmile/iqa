...
/**
 * Servlet implementation class Sec_GetMajorTeachServlet
 */
@WebServlet("/Sec_GetMajorTeachServlet")
public class Sec_GetMajorTeachServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Sec_GetMajorTeachServlet() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		GridDataModel<MajorTeach> model = new GridDataModel<MajorTeach>();
		...
		String college = request.getParameter("mt_college");
		...
		if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(MajorTeachTable.ISNULL, isnull);
	    }
		int total = mtdao.getMajorTeachCount(queryParams);
		...
		model.setRows(mtdao.getAllMajorTeach(start, end, sortStr, orderStr,
				queryParams));
