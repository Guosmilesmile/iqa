...
/**
 * Servlet implementation class GetAllStartClassServlet
 */
@WebServlet("/Sec_GetStartClassServlet")
public class Sec_GetStartClassServlet extends HttpServlet {
     ...
     */
    public Sec_GetStartClassServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<StartClass> model = new GridDataModel<StartClass>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(StartClassTable.SC_ISNULL, isnull);
	    }
	    ...
	    int total = startClassDao.getStartClassCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(startClassDao.getStartClass(start, end, sortStr, orderStr,queryParams,deadLine));
