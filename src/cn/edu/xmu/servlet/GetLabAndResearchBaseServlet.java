 ...
 * 1-5实验室和科研基地 
 */
@WebServlet("/GetLabAndResearchBase")
public class GetLabAndResearchBaseServlet extends HttpServlet{
     ...
     */
    public GetLabAndResearchBaseServlet(){
    	super();
    }
    /**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {				
		...
		GridDataModel<LabAndResearchBase> model = new GridDataModel<LabAndResearchBase>();
	    ...
	    if (deadLine != null) {
			queryParams.put(LabAndResearchBaseTable.LR_DEADLINE, deadLine);
		}
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(LabAndResearchBaseTable.ISNULL, isnull);
	    }
	    
	   
	    int total = labAndResearchBaseDao.getLabAndResearchBaseCount(queryParams);
	    ...
	    model.setRows(labAndResearchBaseDao.getAllLabAndResearchBase(start, end, sortStr, orderStr, queryParams));
