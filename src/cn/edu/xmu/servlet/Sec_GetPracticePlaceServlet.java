 ...
 *
 */
@WebServlet("/Sec_GetPracticePlaceServlet")
public class Sec_GetPracticePlaceServlet extends HttpServlet {
     ...
     */
    public Sec_GetPracticePlaceServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<PracticePlace> model = new GridDataModel<PracticePlace>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(PracticePlaceTable.PP_ISNULL, isnull);
	    }
	    ...
	    int total = practicePlaceDao.getPracticePlaceCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(practicePlaceDao.getPracticePlace(start, end, sortStr, orderStr,queryParams,deadLine));
