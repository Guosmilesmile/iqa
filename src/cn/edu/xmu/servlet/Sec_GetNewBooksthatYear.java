...
/**
 * @author zhantu
 * Servlet implementation class GetNewBooksthatYear
 */
@WebServlet("/GetNewBooksthatYear")
public class Sec_GetNewBooksthatYear extends HttpServlet {
     ...
     */
    public Sec_GetNewBooksthatYear() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<NewBooksthatYear> model = new GridDataModel<NewBooksthatYear>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(NewBooksthatYearTable.ISNULL, isnull);
	    }
	    int total = nbydao.getNewBooksthatYearCount(queryParams);
	    ...
	    model.setRows(nbydao.getNewBooksthatYear(start, end, sortStr, orderStr, queryParams, deadLine));
