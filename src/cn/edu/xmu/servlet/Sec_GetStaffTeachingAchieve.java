...
/**
 * @author zhantu
 * Servlet implementation class GetStaffTeachingAchieve
 */
@WebServlet("/GetStaffTeachingAchieve")
public class Sec_GetStaffTeachingAchieve extends HttpServlet {
     ...
     */
    public Sec_GetStaffTeachingAchieve() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<StaffTeachingAchieve> model = new GridDataModel<StaffTeachingAchieve>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(StaffTeachingAchieveTable.ISNULL, isnull);
	    }
	    int total = stadao.getStaffTeachingAchieveCount(queryParams);
	    ...
	    model.setRows(stadao.getStaffTeachingAchieve(start, end, sortStr, orderStr, queryParams, deadLine));
