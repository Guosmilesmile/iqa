 ...
 */
@WebServlet("/GetSchoolAddress")
public class Sec_GetSchoolAddress extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetSchoolAddress() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<SchoolAddress> model = new GridDataModel<SchoolAddress>();
	  ...
	  //*********fuzhu 
	    ...
	    if(college != null && !"".equals(college)){
	    	if (college.contains("学院")) {//具体的学院才过滤
	    		queryParams.put(SchoolAddressTable.SA_COLLEGE, college);
			}
	    ...
	    int total = schoolAddressDao.getSchoolAddressCount(queryParams);
	    ...
	    model.setRows(schoolAddressDao.getAllSchoolAddress(start, end, sortStr, orderStr, queryParams));
