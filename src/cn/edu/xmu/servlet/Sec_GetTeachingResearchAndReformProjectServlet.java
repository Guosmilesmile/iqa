 ...
 *
 */
@WebServlet("/Sec_GetTeachingResearchAndReformProjectServlet")
public class Sec_GetTeachingResearchAndReformProjectServlet extends HttpServlet {
     ...
     */
    public Sec_GetTeachingResearchAndReformProjectServlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TeachingResearchAndReformProject> model = new GridDataModel<TeachingResearchAndReformProject>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeachingResearchAndReformProjectTable.TRARP_ISNULL, isnull);
	    }
	    ...
	    int total = teachingResearchAndReformProjectDao.getTeachingResearchAndReformProjectCount(queryParams);
	    if(null == pageStr){
	    	pageStr = "1";
	    }if(null == rowsStr){
	    	rowsStr=total+"";
	    ...
	    model.setRows(teachingResearchAndReformProjectDao.getTeachingResearchAndReformProject(start, end, sortStr, orderStr,queryParams,deadLine));
