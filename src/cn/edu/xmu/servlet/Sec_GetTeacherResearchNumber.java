...
/**
 * @author zhantu
 * Servlet implementation class GetTeacherResearchNumber
 */
@WebServlet("/GetTeacherResearchNumber")
public class Sec_GetTeacherResearchNumber extends HttpServlet {
     ...
     */
    public Sec_GetTeacherResearchNumber() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<TeacherResearchNumber> model = new GridDataModel<TeacherResearchNumber>();
	    ...
	    if(isnull != null && !"".equals(isnull)){
	    	queryParams.put(TeacherResearchNumberTable.ISNULL, isnull);
	    }
	    int total = trndao.getTeacherResearchNumberCount(queryParams);
	    ...
	    model.setRows(trndao.getTeacherResearchNumber(start, end, sortStr, orderStr, queryParams, deadLine));
