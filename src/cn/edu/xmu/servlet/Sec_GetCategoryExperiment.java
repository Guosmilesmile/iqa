 ...
 */
@WebServlet("/Sec_GetCategoryExperiment")
public class Sec_GetCategoryExperiment extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetCategoryExperiment() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<CategoryExperiment> model = new GridDataModel<CategoryExperiment>();
	    ...
	    int total = cedao.getCategoryExperimentCount(queryParams);
	    ...
	    model.setRows(cedao.getAllCategoryExperiment(start, end, sortStr, orderStr, queryParams));
