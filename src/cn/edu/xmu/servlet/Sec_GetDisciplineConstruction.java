 ...
 */
@WebServlet("/GetDisciplineConstruction")
public class Sec_GetDisciplineConstruction extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public Sec_GetDisciplineConstruction() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<DisciplineConstruction> model = new GridDataModel<DisciplineConstruction>();
	    ...
	    String college = request.getParameter("dc_college");
	    String roleid = request.getParameter("roleid");
	    
	    Map queryParams = new HashMap();
	    if(college != null && !"".equals(college)){
	    	if (college.contains("学院")) {//具体的学院才过滤
	    		queryParams.put(DisciplineConstructionTable.DC_COLLEGE, college);
			}
	    ...
	    int total = disciplineConstructionDao.getDisciplineConstructionCount(queryParams);
	    ...
	    model.setRows(disciplineConstructionDao.getAllDisciplineConstruction(start, end, sortStr, orderStr, queryParams));
