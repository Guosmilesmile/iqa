...
public class GraduationSituationDetailsServiceImpl implements GraduationSituationDetailsService{
				 ...
				 if (!(paramsGraduationSituation == null || paramsGraduationSituation.keySet().size() == 0)) {
					...
					try {
						...
						while (resultSet.next()) {
							...
							GraduationSituationDetails gsd = new GraduationSituationDetails(++serialNumber,majorName, graduationNumber, 
