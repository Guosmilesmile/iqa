 ...
 *
 */
public class MajorOverview implements Comparable<MajorOverview>{
    ...
    @Override
	public int compareTo(MajorOverview arg0) {
    ...
    public MajorOverview(int serialNumber, String majorName, String majorSetYear, Integer selfTeacher, Integer otherTeacher,
