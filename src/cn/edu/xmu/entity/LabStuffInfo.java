...
public class LabStuffInfo {
	...
	public LabStuffInfo(String rowTitle, String total, String zhenggaoji,
			String fugaoji, String zhongji, String chuji, String noTitle,
			String doctor, String master, String bachelor, String noDegree,
			String below35, String between36_45, String between46_55,
			String upon56, String college) {
		super();
		this.rowTitle = rowTitle;
		this.total = total;
		this.zhenggaoji = zhenggaoji;
