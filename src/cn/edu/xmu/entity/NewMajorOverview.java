 ...
 *
 */
public class NewMajorOverview implements Comparable<NewMajorOverview>{
    ...
    @Override
	public int compareTo(NewMajorOverview arg0) {
    ...
    public NewMajorOverview(int serialNumber, String majorName, String majorSetYear, Integer selfTeacher, Integer otherTeacher,
