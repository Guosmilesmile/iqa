 ...
 *
 */
public class FullTimeTeacherInfo
{
	private int ftti_id;
	...
	public FullTimeTeacherInfo()
	{
		super();
	}

	public FullTimeTeacherInfo(int ftti_id, String ftti_name, String ftti_worknumber, String ftti_gender,
